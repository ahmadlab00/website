...
<head>
    ...
    <title>Main Page - Supptopia</title>
...
<body>
    ...
    <div class="newSeason">
        <div class="nsItem">
            <img src="./img/pexels-victor-freitas-791764.jpg" alt="" class="nsImg">
        </div>
        <div class="nsItem">
        ...
        <div class="nsItem">
            <img src="./img/pexels-victor-freitas-949128.jpg" alt="" class="nsImg">
        </div>
    </div>
    <footer>
        ...
        <div class="footerRight">
            ...
            <div class="footerRightMenu">
                <span class="copyright">Supptopia. All rights reserved. 2023.</span>
            </div>
        </div>
    </footer>
    </footer>
